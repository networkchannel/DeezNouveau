            ...
            >
              ...
              return (
                ...
                >
                  ...
                  <div data-pack-card={pack.badge ? "highlight" : "plain"} className={`relative bg-gradient-to-b from-[rgba(22,18,32,0.50)] to-[rgba(10,5,16,0.40)] backdrop-blur-xl border ${pack.badge ? 'border-violet-500/40' : 'border-white/[0.08]'} rounded-2xl flex flex-col h-full transition-colors duration-200 group-hover:border-violet-400/60`}>
                    {/* Content */}
